...
public class RegistroCasoController {
	...
	throws ParseException{
		rService.listarId(registroCaso.getIdRegistro());
		return "listRegistroCasos";
	}
	...
	throws ParseException{
		...
		registroCaso.setDescripcion(registroCaso.getDescripcion());
		listaRegistroCasos = rService.buscarDescripcion(registroCaso.getDescripcion());
